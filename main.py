...
group.add_argument('-s','--save',default=True, action='store_true', help='save the qualitative results')
...
parser.add_argument('--past_len', type=int, default=20, help='past length')
...
# save folder
name_test = str(datetime.datetime.now())[:10] + 'past_' + str(n) + 'acc_' + str(acceleration)
...
# load xml
list_xml = os.listdir('H:\\trajectoryprediction\code\kalman\kitti_raw_data\\2011_09_26')
